...
public class EverydayFragmentActivity extends FragmentActivity {
...
//		String params = getIntent().getStringExtra(SAMPLE_NAME);
	...
	public void toast(final int resId) {
		runOnUiThread(new Runnable() {
			...
			@Override
			public void run() {
				Toast.makeText(EverydayFragmentActivity.this, resId, Toast.LENGTH_SHORT).show();
			}
	...
	public void toast(final String text) {
		runOnUiThread(new Runnable() {
			...
			@Override
			public void run() {
				Toast.makeText(EverydayFragmentActivity.this, text, Toast.LENGTH_SHORT).show();
			}
